...
#[tauri::command]
pub fn docker_action(id: String, action: String) -> Result<String, String> {
    match action.as_str() {
        "start" | "stop" | "restart" => {
...
#[tauri::command]
pub fn get_docker_logs(id: String) -> Result<String, String> {
...
#[tauri::command]
pub fn get_mongo_status() -> Result<MongoStatus, String> {
...
pub fn get_collection_count(db_name: &str) -> Result<u32, String> {
    let eval_str = format!(
...
#[tauri::command]
pub fn get_redis_status() -> Result<RedisStatus, String> {
...
#[tauri::command]
pub fn get_postgres_status() -> Result<PostgresStatus, String> {
    // Get version
...
pub fn format_pg_size(bytes: u64) -> String {
    if bytes == 0 {
...
pub fn get_pg_table_count(db_name: &str) -> Result<u32, String> {
    let output = run_command(
        "psql",
        &[
            "-d",
...
#[tauri::command]
pub fn get_node_processes() -> Result<Vec<NodeProcess>, String> {
