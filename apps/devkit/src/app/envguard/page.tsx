...
import { Header } from '@/components/envguard/Header';
import { Sidebar } from '@/components/envguard/Sidebar';
import { TabBar } from '@/components/envguard/TabBar';
import { VariableTable } from '@/components/envguard/VariableTable';
import { DiffView } from '@/components/envguard/DiffView';
import { Validator } from '@/components/envguard/Validator';
import { Generator } from '@/components/envguard/Generator';
import { Encryptor } from '@/components/envguard/Encryptor';
import { EmptyState } from '@/components/envguard/EmptyState';
import { ToastContainer } from '@/components/envguard/Toast';

export default function EnvGuardPage() {
  const {
    files,
    projectName,
    loading,
