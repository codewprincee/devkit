...
function App() {
  ...
  return (
    <div className={`app ${detailPort ? "has-detail" : ""}`}>
      <header className="topbar">
        <div className="topbar-brand">
          <svg
            ...
            aria-hidden="true"
          >
            <rect x="2" y="4" width="24" height="20" rx="4" stroke="url(#logo-grad)" strokeWidth="2" />
            <circle cx="8" cy="14" r="2" fill="url(#logo-grad)" />
            <rect x="12" y="12" width="10" height="4" rx="2" fill="url(#logo-grad)" opacity="0.5" />
            <defs>
              <linearGradient id="logo-grad" x1="2" y1="4" x2="26" y2="24">
                <stop stopColor="#6366f1" />
                <stop offset="1" stopColor="#8b5cf6" />
              </linearGradient>
            </defs>
          </svg>
          <h1 className="topbar-title">PortMan</h1>
        </div>
      ...
      <main className="content">
        ...
        <div className="table-toolbar">
          <div className="toolbar-left">
            ...
            {selectedPids.size > 0 && (
              <button className="btn btn-bulk-kill" onClick={handleBulkKillRequest} type="button">
      ...
      <div className="auto-refresh-indicator" aria-live="polite">
